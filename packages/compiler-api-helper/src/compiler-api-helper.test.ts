...
describe('convertType', () => {
  ...
  it('complex types', () => {
    ...
    if (!type1 || type1.type.__type !== 'ObjectTO') {
      return
    }
    expect(helper.getObjectProps(type1.type.storeKey)).toStrictEqual([
      {
  ...
  it('promise', () => {
    ...
    if (!type0 || type0.type.__type !== 'PromiseTO') {
      return
    }
  ...
  it('promise-like', () => {
    ...
    if (!type0 || type0.type.__type !== 'PromiseLikeTO') {
      return
    }
